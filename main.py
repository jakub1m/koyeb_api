...
If the title (provided within <title> tags) suggests that the song may be inappropriate (e.g., “Erika” or “Katiusza”), automatically classify it as negative sentiment (sentiment=2).
Block all remixes, hardstyle versions, bass-boosted versions, and similar alternate versions.
